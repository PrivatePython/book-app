...
export class Card extends DivComponent {
  ...
  render() {
    ...
    const addedToFavorite = this.appState.favorites.find(b => b.key === this.cardState.key);
    this.el.innerHTML = `
      ...
      <div class="card__info">
        ...
        <div class="card__footer">
          <button class="button__add ${addedToFavorite ? "button__active" : ''}">
            ${addedToFavorite 
              ? `<img src="/static/favorites.svg" alt="added to favorites" />`
              : `<img src="/static/favorites-white.svg" alt="add to favorites" />`
            }
          </button>
        </div>
      </div>
